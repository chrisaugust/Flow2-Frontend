...
//       subtotals[exp.category_id] += parseFloat(exp.amount);
...
//   let total = 0;
//   incomes.forEach(inc => {
//     const [year, month] = inc.received_on.split('-').map(Number);
//     if (year === currentMonth.getFullYear() && month === currentMonth.getMonth() + 1) {
...
const Dashboard = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6">Flow2 Dashboard</h1>
